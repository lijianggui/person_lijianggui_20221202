<template>
	<view class="uni-select-cy" :style="{'z-index':zindex}">
		<view class="uni-select-cy-select" :class="{ active: active }" @click.stop="handleSelect"  style="margin-left: 10px;">
			<!-- 禁用mask -->
			...
			<!-- 为空时的显示文案 -->
			<view style="margin-right: 30px;font-size: 16px;"  v-if="realValue.length == 0&&showplaceholder">{{ placeholder }}</view>
			<!-- 禁用图标 -->
